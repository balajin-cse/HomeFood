/*
  # Insert Sample Cook Profiles and Menu Items

  1. Sample Data
    - Cook profiles with proper auth user creation
    - Menu items for each cook
    - Proper foreign key relationships

  2. Security
    - Maintains all existing RLS policies
    - Creates sample data that works with existing constraints
*/
...
-- Update the customer to not be a cook
UPDATE profiles SET is_cook = false WHERE email = 'bala@example.com';
